...
public class PhoneActivity extends Activity implements View.OnClickListener {
  ...
  int frequency = 1;
  String filename =
    "cK_" + new SimpleDateFormat("yyyyMMdd_HHmm'.txt'").format(new Date());
  ...
  public void btnInfo(View view) {
    String myip = Formatter.formatIpAddress(
      wm.getConnectionInfo().getIpAddress()
    );
    Toast
      .makeText(
        getApplicationContext(),
        "© 2016 CardioKEN by Harry Vasanth \n" +
        "Web server ip: " +
        myip +
        ":8080",
        Toast.LENGTH_SHORT
  ...
  public void sendData(String wearData) {
    ...
    String udpMsg =
      "timestamp" + ", " + timeStamp + ", " + "hr" + ", " + wearData;
